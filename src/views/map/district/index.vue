<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="级别 1-区县，2-街道，3-社区" prop="level">
        <el-input
          v-model="queryParams.level"
          placeholder="请输入级别 1-区县，2-街道，3-社区"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['map:district:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['map:district:export']"
        >导出</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="districtList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="级别 1-区县，2-街道，3-社区" align="center" prop="level" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="级别 1-区县，2-街道，3-社区" prop="level">
          <el-input v-model="form.level" placeholder="请输入级别 1-区县，2-街道，3-社区" />
        </el-form-item>
...
<script>
import { listDistrict, getDistrict, delDistrict, addDistrict, updateDistrict, exportDistrict } from "@/api/map/district";
